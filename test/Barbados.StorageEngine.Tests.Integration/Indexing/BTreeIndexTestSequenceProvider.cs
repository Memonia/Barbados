...
{
	internal sealed class BTreeIndexTestSequenceProvider : TheoryData<BTreeIndexTestSequence>
	{
		public BTreeIndexTestSequenceProvider()
		{
			...
			var minLen = Constants.MinimalMaxIndexKeyLength;
			var s1 = maxLen / 100;
			var s2 = maxLen / 10;
			var s3 = maxLen / 1;
			...
			// Same, but cut the key length to the minimum
