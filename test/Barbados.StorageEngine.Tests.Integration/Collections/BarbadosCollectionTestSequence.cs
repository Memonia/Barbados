...
{
	public sealed class BarbadosCollectionTestSequence(string name, IEnumerable<BarbadosDocument> documents) : IXunitSerializable
	{
		...
		public BarbadosCollectionTestSequence() : this(default!, default!)
		{
