...
namespace Barbados.StorageEngine.Helpers
{
	internal static class BitExtensions
	{
		...
		public static bool Get(this byte bits, byte mask) => Get((ulong)bits, mask);
		public static bool Get(this uint bits, uint mask) => Get((ulong)bits, mask);
		...
		public static byte GetBits(this byte bits, byte mask, int shift) => (byte)GetBits((ulong)bits, mask, shift);
		public static uint GetBits(this uint bits, uint mask, int shift) => (uint)GetBits((ulong)bits, mask, shift);
